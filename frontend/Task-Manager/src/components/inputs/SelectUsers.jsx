        ...
        <div className="space-y-4 h-[60vh] overflow-y-auto">
            {allUsers.map((user)=> (
              <div className="flex items-center gap-4 p-3 border-b border-gray-200" key={user._id}>
                ...
                <input type="checkbox" checked={tempSelectedUsers.includes(user._id)} onChange={()=>handleUserSelection(user._id)} className='text-primary bg-gray-100 border-gray-300 rounded-sm outline-none' />
              </div>
            ))}
        </div>
