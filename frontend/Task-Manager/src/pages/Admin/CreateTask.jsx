...
const CreateTask = () => {
  ...
  const [currentTask, setCurrentTask] = useState(null);  // Add this state
  ...
  const getTaskDetailsByID = async ()=>{
    ...
    if(response.data){
      ...
      setCurrentTask(taskInfo);  // Now this will work
  ...
  return (
    <DashboardLayout activeMenu="Create Task">
      <div className="mt-5">
        <div className="grid grid-cols-1 md:grid-cols-4 mt-4">
          <div className="form-card col-span-3">
            <div className="flex items-center justify-between">
              ...
              {taskId && (
                <button className="flex items-center gap-1.5 text-[13px] font-medium text-rose-500 bg-rose-50 rounder px-2 py-1 border border-rose-100 hover:border-rose-300 cursor-pointer" onClick={()=> setOpenDeleteAlert(true)}>
        ...
        <div className="mt-3">
          <label className="text-xs front-medium text-slate-600">Add Attachments</label>
